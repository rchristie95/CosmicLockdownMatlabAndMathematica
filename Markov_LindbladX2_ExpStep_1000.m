function [plotSpan, RhoStore] = Markov_LindbladX2_ExpStep_1000( ...
...
for k = 1:nSteps
    ...
    if t < -1.
        ...
        GGamma = (pi*lambda^2 * (a2*a2)) / (64*mu^4);
...
Lc    = conj(L);
D = kron(Lc, L) - 0.5*( kron(I, L2) + kron(L2.', I) );
end
